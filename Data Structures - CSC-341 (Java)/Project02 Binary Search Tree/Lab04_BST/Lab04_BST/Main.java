...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortedList<Track> tracks = new SortedList<Track>();
        buildDB(tracks,csvData);//********** change back to csvData after testing!!!!!******************
        tracks.print();
        // example
     ...
     */
    public static void buildDB(SortedList<Track> tracks, ArrayList<String> data) {
        Order.byArtist byArtist = new Order.byArtist();
